...
time_step=100; "set time step"
cover_range=100; "set cover range, or let's say time window"
over_lapping=90; "choose overlapping rate, which means how many datapoints are repeated in next coming sample"
